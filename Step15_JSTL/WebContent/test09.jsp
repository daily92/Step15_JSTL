...
<body>
<%
	request.setAttribute("price", "1000000000");
	request.setAttribute("weight", "48.1234");
%>
	<p>가격 : <strong>1,000,000,000</strong></p>
	...
	<p>몸무게 : <strong><fmt:formatNumber value="${weight }"/></strong></p>
